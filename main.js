...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            feat_ext_title: "The NeoPlayers Advantage", feat_ext_subtitle: "Ultimate features built by enthusiasts, for enthusiasts.",
            feat_multi_title: "Multi-Screen PiP", feat_multi_desc: "Watch up to 4 matches or channels simultaneously with Quad-Screen and Dual-Screen modes.",
            feat_match_title: "Match Today Hub", feat_match_desc: "Real-time live scores, match timings, and league tables integrated directly into the player.",
            feat_continue_title: "Intelligent Resume", feat_continue_desc: "Pick up exactly where you left off. Smart episode tracking for all your favorite series and movies.",
            feat_speed_title: "Hybrid Speed Test", feat_speed_desc: "Built-in diagnostics to test your network's capability for 4K streaming and high-bitrate content.",
            matrix_viewing: "Viewing Modes", matrix_viewing_std: "Single channel limit", matrix_viewing_neo: "Quad-Screen PIP Support",
            matrix_sports: "Live Sports", matrix_sports_std: "Manual schedule checks", matrix_sports_neo: "Real-time Match Today Integration",
            matrix_continuity: "Continuity", matrix_continuity_std: "Search next episode manually", matrix_continuity_neo: "Intelligent Continue Watching",
        ...
        fr: {
            ...
            btn_download_apk: "Télécharger l'APK Maintenant",
            feat_ext_title: "L'Avantage NeoPlayers", feat_ext_subtitle: "Des fonctionnalités ultimes conçues par des passionnés, pour des passionnés.",
            feat_multi_title: "Multi-Écran PiP", feat_multi_desc: "Regardez jusqu'à 4 matchs ou chaînes simultanément avec les modes Quad-Screen et Dual-Screen.",
            feat_match_title: "Hub Match Today", feat_match_desc: "Scores en direct, horaires des matchs et classements intégrés directement dans le lecteur.",
            feat_continue_title: "Reprise Intelligente", feat_continue_desc: "Reprenez exactement là où vous vous étiez arrêté. Suivi intelligent des épisodes pour vos séries et films.",
            feat_speed_title: "Test de Vitesse Hybride", feat_speed_desc: "Diagnostics intégrés pour tester la capacité de votre réseau pour le streaming 4K.",
            matrix_viewing: "Modes de Visionnage", matrix_viewing_std: "Limite d'une seule chaîne", matrix_viewing_neo: "Support Quad-Screen PIP",
            matrix_sports: "Sports en Direct", matrix_sports_std: "Vérification manuelle des horaires", matrix_sports_neo: "Intégration 'Match Today' en Temps Réel",
            matrix_continuity: "Continuité", matrix_continuity_std: "Recherche manuelle du prochain épisode", matrix_continuity_neo: "Reprise de Lecture Intelligente",
        ...
        ar: {
            ...
            feat_ext_title: "ميزة NeoPlayers", feat_ext_subtitle: "ميزات فائقة صممها عشاق التقنية من أجلكم.",
            feat_multi_title: "تعدد الشاشات PiP", feat_multi_desc: "شاهد ما يصل إلى 4 مباريات أو قنوات في وقت واحد مع أوضاع الشاشة الرباعية والثنائية.",
            feat_match_title: "مركز مباريات اليوم", feat_match_desc: "نتائج مباشرة، أوقات المباريات، وجداول الدوريات مدمجة مباشرة في المشغل.",
            feat_continue_title: "الاستئناف الذكي", feat_continue_desc: "اكمل المشاهدة من حيث توقفت. تتبع ذكي للحلقات لجميع المسلسلات والأفلام المفضلة لديك.",
            feat_speed_title: "اختبار السرعة الهجين", feat_speed_desc: "تشخيصات مدمجة لاختبار قدرة شبكتك على بث 4K والمحتوى عالي الجودة.",
            matrix_viewing: "أوضاع المشاهدة", matrix_viewing_std: "قناة واحدة كحد أقصى", matrix_viewing_neo: "دعم الشاشات الرباعية والـ PiP",
            matrix_sports: "الرياضات المباشرة", matrix_sports_std: "التحقق اليدوي من المواعيد", matrix_sports_neo: "تكامل ذكي مع Match Today",
            matrix_continuity: "الاستمرارية", matrix_continuity_std: "البحث عن الحلقة التالية يدوياً", matrix_continuity_neo: "الاستئناف الذكي للمشاهدة",
